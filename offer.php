    ...
    <div class="container m-auto col-8">
        ...
        <div class="nav" style="    padding: 14px 0px 14px 0px;  background: whitesmoke;">
            <div class="nav_link" style="background: black; margin:auto">
                <a href="breakfast.php" style="text-decoration: none;color: white;font-size: 22px;margin-right: 10px;" class="mr-4">Breakfast</a>
                <a href="launch.php" style="text-decoration: none;color: white;font-size: 22px;margin-right: 10px;">Launch</a>
                <a href="dinner.php" style="text-decoration: none;color: white;font-size: 22px;margin-right: 10px;">Dinner</a>
                <a href="fastfood.php" style="text-decoration: none;color: white;font-size: 22px;margin-right: 10px;">Fastfood</a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($sql_s)) {
                ...
                <a href="cart.php?food_id=' . $row['id'] . '&&food=' . $row['food'] . '&&avatar=' . $row['avatar'] . '"> <img src="img/cart/cart.png" style="    border-style: none;  height: 36px;  float: right;  background: yellow;"></a>
                </div>
                </div>
              </div>';
                    } else {
